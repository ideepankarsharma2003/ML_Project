...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            logging.info('Loading data transformer object')
            ...
            logging.info('Data transformer object loaded successfully')
            return preprocessor
        
        except Exception as e:
            logging.error('Error occured while loading data transformer object')
